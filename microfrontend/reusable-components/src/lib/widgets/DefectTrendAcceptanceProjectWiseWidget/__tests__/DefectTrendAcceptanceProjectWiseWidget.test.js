...
import DefectTrendAcceptanceProjectWiseWidget from '../DefectTrendAcceptanceProjectWiseWidget'
...
describe('DefectTrendAcceptanceProjectWiseWidget', () => {
  ...
  it('render component', async () => {
    ...
    await waitFor(() => {
      render(<DefectTrendAcceptanceProjectWiseWidget {...props} />)
    })
  })
})
