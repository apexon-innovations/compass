...
import ProjectRatingComplianceWidget from '../ProjectRatingComplianceWidget'
...
describe('ProjectRatingComplianceWidget', () => {
  ...
  it('render component', async () => {
    ...
    await waitFor(() => {
      render(<ProjectRatingComplianceWidget {...props} />)
    })
  })
})
