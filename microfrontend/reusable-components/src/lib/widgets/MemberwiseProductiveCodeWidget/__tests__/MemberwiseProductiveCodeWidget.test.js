...
import MemberwiseProductiveCodeWidget from '../MemberwiseProductiveCodeWidget'
...
describe('MemberwiseProductiveCodeWidget', () => {
  ...
  it('render component', async () => {
    ...
    await waitFor(() => {
      render(<MemberwiseProductiveCodeWidget {...props} />)
    })
  })
})
