...
import MemberwiseActivityMetricsWidget from '../MemberwiseActivityMetricsWidget'
...
describe('MemberwiseActivityMetricsWidget', () => {
  ...
  it('render component', async () => {
    ...
    await waitFor(() => {
      render(<MemberwiseActivityMetricsWidget {...props} />)
    })
  })
})
