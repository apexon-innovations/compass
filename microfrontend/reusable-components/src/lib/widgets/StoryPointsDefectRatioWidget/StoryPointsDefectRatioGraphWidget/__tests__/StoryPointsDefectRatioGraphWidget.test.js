...
import StoryPointsDefectRatioGraphWidget from '../StoryPointsDefectRatioGraphWidget'
...
describe('StoryPointsDefectRatioGraphWidget', () => {
  ...
  it('render component', async () => {
    ...
    await waitFor(() => {
      render(<StoryPointsDefectRatioGraphWidget {...props} />)
    })
  })
})
