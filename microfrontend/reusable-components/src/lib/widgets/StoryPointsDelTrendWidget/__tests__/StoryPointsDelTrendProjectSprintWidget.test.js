...
import StoryPointsDelTrendProjectSprintWidget from '../StoryPointsDelTrendProjectSprintWidget'
...
describe('StoryPointsDelTrendProjectSprintWidget', () => {
  ...
  it('render component', async () => {
    ...
    await waitFor(() => {
      render(<StoryPointsDelTrendProjectSprintWidget {...props} />)
    })
  })
})
