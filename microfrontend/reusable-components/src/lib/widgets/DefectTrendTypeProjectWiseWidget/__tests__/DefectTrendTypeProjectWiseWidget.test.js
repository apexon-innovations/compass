...
import DefectTrendTypeProjectWiseWidget from '../DefectTrendTypeProjectWiseWidget'
...
describe('DefectTrendTypeProjectWiseWidget', () => {
  ...
  it('render component', async () => {
    ...
    await waitFor(() => {
      render(<DefectTrendTypeProjectWiseWidget {...props} />)
    })
  })
})
