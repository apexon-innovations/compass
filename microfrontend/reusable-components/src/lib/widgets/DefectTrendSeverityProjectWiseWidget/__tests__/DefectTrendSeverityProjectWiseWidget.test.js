...
import DefectTrendSeverityProjectWiseWidget from '../DefectTrendSeverityProjectWiseWidget'
...
describe('DefectTrendSeverityProjectWiseWidget', () => {
  ...
  it('render component', async () => {
    ...
    await waitFor(() => {
      render(<DefectTrendSeverityProjectWiseWidget {...props} />)
    })
  })
})
