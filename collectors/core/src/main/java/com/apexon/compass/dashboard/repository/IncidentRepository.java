...
import com.apexon.compass.dashboard.model.Incident;
...
public interface IncidentRepository extends MongoRepository<Incident, ObjectId> {
	...
	Page<Incident> findIncidentsBySeverityAndOpenTimeBetween(String[] severityValues, long startDate, long endDate,
			Pageable pageable);
