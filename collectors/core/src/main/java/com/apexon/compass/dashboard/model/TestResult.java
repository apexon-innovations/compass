...
/**
 * Represents a collection of test suites that have been executed. This may include a unit
 * test run, a security scan, static analysis, functional tests, manual acceptance tests
 * or bug reports.
 *
 * Possible Collectors: Hudson (in scope) ALM Various build system test results
 *
 */
