...
import com.apexon.compass.dashboard.repository.ApiTokenRepository;
import com.apexon.compass.dashboard.repository.UserInfoRepository;
import com.apexon.compass.dashboard.util.Encryption;
import com.apexon.compass.dashboard.util.EncryptionException;
import com.apexon.compass.dashboard.util.UnsafeDeleteException;
...
public class ApiTokenServiceImpl implements ApiTokenService {
	...
	public String getApiToken(String apiUser, Long expirationDt) throws EncryptionException, HygieiaException {
		...
		if (apiToken == null) {
			...
			throw new HygieiaException("Token already exists for " + apiUser + " expiring "
					+ sdf.format(new Date(apiToken.getExpirationDt())), HygieiaException.DUPLICATE_DATA);
		}
		return apiKey;
	}
	 ...
	 * @return 0 = equal, -1 = firstDate is before secondDate, 1 = firstDate is after
	 * secondDate
	 */
