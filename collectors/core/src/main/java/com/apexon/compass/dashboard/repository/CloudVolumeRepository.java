...
import com.apexon.compass.dashboard.model.CloudVolumeStorage;
...
public interface CloudVolumeRepository
		extends CrudRepository<CloudVolumeStorage, ObjectId>, QuerydslPredicateExecutor<CloudVolumeStorage> {
