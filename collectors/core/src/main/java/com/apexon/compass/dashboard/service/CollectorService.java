...
public interface CollectorService {
	 ...
	 * @param collectorType collector type
	 * @param {@link org.springframework.data.domain.Pageable} object to determine which
	 * page to return
	 * @return CollectorItems matching the specified type
	 */
	Page<CollectorItem> collectorItemsByTypeWithFilter(CollectorType collectorType, String descriptionFilter,
			Pageable pageable);
	...
	/**
	 * Creates a new CollectorItem. If a CollectorItem already exists with the same
	 * collector id and options, that CollectorItem will be returned instead of creating a
	 * new CollectorItem.
	...
	/**
	 * Creates a new CollectorItem. If a CollectorItem already exists with the same
	 * collector id and niceName, that CollectorItem will be returned instead of creating
	 * a new CollectorItem.
	 * @param item CollectorItem to create
	 * @return created CollectorItem
	 */
	...
	CollectorItem createCollectorItemSelectOptions(CollectorItem item, Map<String, Object> allOptions,
			Map<String, Object> selectOptions);

	CollectorItem createCollectorItemSelectOptions(CollectorItem item, Collector collector,
			Map<String, Object> allOptions, Map<String, Object> selectOptions);
