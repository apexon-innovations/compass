...
/**
 * Score Criteria Criteria Conditions - No Widget Found - No Data Found in Widget
...
public class ScoreCriteria {
	...
	public static ScoreCriteria cloneScoreCriteria(ScoreCriteria scoreCriteria) {
		...
		scoreCriteriaClone.setNoDataFound(ScoreTypeValue.cloneScoreTypeValue(scoreCriteria.getNoDataFound()));
		scoreCriteriaClone.setNoWidgetFound(ScoreTypeValue.cloneScoreTypeValue(scoreCriteria.getNoWidgetFound()));
		...
		for (ScoreThresholdSettings dataRangeThreshold : dataRangeThresholds) {
			dataRangeThresholdsClone.add(ScoreThresholdSettings.cloneScoreThresholdSettings(dataRangeThreshold));
		}
	...
	public String toString() {
		return "ScoreCriteria{" + "noWidgetFound=" + noWidgetFound + ", noDataFound=" + noDataFound
