...
import com.apexon.compass.dashboard.model.webhook.github.GitHubRepo;
...
public interface GitHubRepoRepository
		extends BaseCollectorItemRepository<GitHubRepo>, QuerydslPredicateExecutor<GitHubRepo> {
