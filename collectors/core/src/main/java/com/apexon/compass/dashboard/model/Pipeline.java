...
public class Pipeline extends BaseModel {
	...
	/**
	 * not including this in the map above because the enum allows us to use ordinals to
	 * iterate through pipeline progression
	 */
	 ...
	 * @param environmentName the environment name including the pseudo environments
	 * "Build" and "Commit"
	 * @param commit
	 */
	...
	/**
	 * Gets all pipeline commits as a map of scmrevision number, pipelinecommit for a
	 * given stage.
	 *
	 * uses a case insensitive map of the pipeline stage names due tot he way the UI
	 * currently stores mapped environments with lowercase for the stage type and the
	 * canonical name
	 * @param environmentName the environment name including the pseudo environments
	 * "Build" and "Commit"
	 * @return
