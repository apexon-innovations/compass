...
public class Cmdb extends BaseModel {
	...
	/**
	 * ownerSubDept is used in correlation with the ownerDept as a sub department of the
	 * ownerDept
	 */
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.configurationItem, this.configurationKey, this.assignmentGroup, this.appServiceOwner,
				this.businessOwner, this.supportOwner, this.developmentOwner, this.ownerDept, this.ownerSubDept,
				this.itemType, this.configurationItemSubType, this.configurationItemType, this.legacyServiceManagerName,
				this.commonName);
	}
