...
import com.apexon.compass.dashboard.model.InfrastructureScan;
...
public interface InfrastructureScanRepository extends CrudRepository<InfrastructureScan, ObjectId> {
	...
	List<InfrastructureScan> findByCollectorItemIdAndTimestampIsBetweenOrderByTimestampDesc(ObjectId collectorItemId,
	...
	InfrastructureScan findTopByBusinessServiceAndBusinessApplicationOrderByTimestampDesc(String businessService,
			String businessApplication);

	List<InfrastructureScan> findAllByBusinessServiceOrderByTimestampDesc(String businessService);

	List<InfrastructureScan> findAllByBusinessServiceAndBusinessApplicationOrderByTimestampDesc(String businessService,
			String businessApplication);
