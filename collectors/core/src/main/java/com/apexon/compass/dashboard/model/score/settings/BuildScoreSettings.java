...
public class BuildScoreSettings extends ScoreComponentSettings {
	...
	public static BuildScoreSettings cloneBuildScoreSettings(BuildScoreSettings buildScoreSettings) {
		...
		buildScoreSettingsClone
			.setStatus(ScoreComponentSettings.cloneScoreComponentSettings(buildScoreSettings.getStatus()));

		buildScoreSettingsClone
			.setDuration(BuildDurationScoreSettings.cloneBuildDurationScoreSettings(buildScoreSettings.getDuration()));
	...
	public static class BuildDurationScoreSettings extends ScoreComponentSettings {
		...
		public static BuildDurationScoreSettings cloneBuildDurationScoreSettings(
				BuildDurationScoreSettings buildDurationScoreSettings) {
			...
			ScoreComponentSettings.copyScoreComponentSettings(buildDurationScoreSettings,
					buildDurationScoreSettingsClone);
			buildDurationScoreSettingsClone
				.setBuildDurationThresholdInMillis(buildDurationScoreSettings.getBuildDurationThresholdInMillis());
		...
		public String toString() {
			return "BuildDurationScoreSettings{" + "buildDurationThresholdInMillis=" + buildDurationThresholdInMillis
					+ ", disabled=" + isDisabled() + ", weight=" + getWeight() + ", criteria=" + getCriteria() + '}';
		}
	...
	@Override
	public String toString() {
		return "BuildScoreSettings{" + "duration=" + duration + ", status=" + status + ", numberOfDays=" + numberOfDays
				+ ", disabled=" + isDisabled() + ", weight=" + getWeight() + ", criteria=" + getCriteria() + '}';
	}
