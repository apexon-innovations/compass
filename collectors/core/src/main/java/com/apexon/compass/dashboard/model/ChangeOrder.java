...
public class ChangeOrder extends BaseModel {
	...
	public void setPlannedStart(String plannedStart) {
		this.plannedStart = DATE_FORMATTER.parseMillis(plannedStart);
	}
	...
	public void setPlannedEnd(String plannedEnd) {
		this.plannedEnd = DATE_FORMATTER.parseMillis(plannedEnd);
	}
	...
	public void setDateEntered(String dateEntered) {
		this.dateEntered = DATE_FORMATTER.parseMillis(dateEntered);
	}
	...
	public void setBackoutDuration(String backoutDuration) {
	...
	public void setCloseTime(String closeTime) {
		this.closeTime = DATE_FORMATTER.parseMillis(closeTime);
	}

	public String getExtProjectRef() {
		return extProjectRef;
	}

	public void setExtProjectRef(String extProjectRef) {
		this.extProjectRef = extProjectRef;
	}
	...
	public void setrFCType2(String rFCType2) {
	...
	/**
	 * Returns human readable string of the ChangeOrder Object. * equals(Object object)
	...
	public String toString() {
		...
		builder.append("changeID: ").append(changeID);
