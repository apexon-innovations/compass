 ...
 */
public interface CodeQualityRepository
		extends CrudRepository<CodeQuality, ObjectId>, QuerydslPredicateExecutor<CodeQuality> {
	...
	List<CodeQuality> findByCollectorItemIdAndNameAndVersionOrderByTimestampDesc(ObjectId collectorItemId, String name,
			String version);
	...
	List<CodeQuality> findByCollectorItemIdAndTimestampIsBetweenOrderByTimestampDesc(ObjectId collectorItemId,
