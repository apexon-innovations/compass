...
public class ScoreComponentMetric extends ScoreComponentMetricBase {
	...
	public String toString() {
		return "ScoreComponentMetric{" + "score='" + getScore() + '\'' + ", total='" + getTotal() + '\'' + ", weight='"
				+ getWeight() + '\'' + ", refId='" + getRefId() + '\'' + ", displayId='" + getDisplayId() + '\''
				+ ", displayName='" + getDisplayName() + '\'' + ", message='" + getMessage() + '\'' + ", propagate='"
				+ getPropagate() + '\'' + ", state='" + getState() + '\'' + ", noScore=" + isNoScore() + ", children="
				+ children + '\'' + ", options=" + getOptions() + '\'' + ", alert='" + isAlert() + '}';
	}
