...
/**
 * A collection of auto discovered end points that represent a software project under
 * development and/or in production use.
 *
 */
...
public class AutoDiscovery extends BaseModel {
	...
	public AutoDiscovery(AutoDiscoveryMetaData metaData, List<AutoDiscoveredEntry> codeRepoEntries,
	...
	public void setMetaData(AutoDiscoveryMetaData metaData) {
