...
public class ScoreTypeValue {
	...
	public Double getScoreValue() {
		if (null != scoreType && (scoreType == ScoreType.no_score || scoreType == ScoreType.zero_score)) {
			return 0.0d;
		}
		return scoreValue;
	}
	...
	public String toString() {
		return "ScoreTypeValue{" + "scoreType=" + scoreType + ", scoreValue=" + scoreValue + ", propagate=" + propagate
				+ '}';
	}
