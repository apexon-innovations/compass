...
public class GithubGraphQLQuery {
	...
	public static final String QUERY_COMMIT_MAIN = "          pageInfo {\n" + "            endCursor\n"
			+ "            hasNextPage\n" + "          }\n" + "          edges {\n" + "            cursor\n"
			+ "            node {\n" + "              oid\n" + "              changedFiles\n"
			+ "              deletions\n" + "              additions\n" + "              parents(first:10) {\n"
			+ "                nodes {\n" + "                  oid\n" + "                }\n" + "              }\n"
	...
	public static final String QUERY_PULL_MAIN = "      totalCount \n" + "      pageInfo {\n" + "        endCursor\n"
			+ "        hasNextPage\n" + "      }\n" + "      edges {\n" + "        cursor\n" + "        node {\n"
			+ "          number\n" + "          mergeable\n" + "          state\n" + "          createdAt\n"
			+ "          updatedAt\n" + "          mergedAt\n" + "          changedFiles\n" + "          deletions\n"
			+ "          additions\n" + "          baseRef {\n" + "            target {\n" + "                oid\n"
	...
	public static final String QUERY_COMMENTS = "      comments(first: 100 after: $afterComment) {\n"
			+ "        totalCount\n" + "        pageInfo {\n" + "          endCursor\n" + "          hasNextPage\n"
			+ "        }\n" + "        nodes {\n" + "          bodyText\n" + "            author {\n"
			+ "              login\n" + "            }\n" + "          createdAt \n" + "          updatedAt \n"
			+ "        }\n" + "      }\n";

	public static final String QUERY_REVIEWS = "      reviews(last: 100 after: $afterReview) {\n"
			+ "        totalCount\n" + "        pageInfo {\n" + "          endCursor\n" + "          hasNextPage\n"
			+ "        }\n" + "        nodes {\n" + "          id\n" + "          bodyText\n" + "          state\n"
			+ "            author {\n" + "              login\n" + "            }\n" + "          createdAt \n"
			+ "          updatedAt \n" + "        }\n" + "      }\n";
	...
	public static final String QUERY_ISSUE_MAIN = "      totalCount \n" + "      pageInfo {\n" + "        endCursor\n"
			+ "        hasNextPage\n" + "      }\n" + "      edges {\n" + "        cursor\n" + "        node {\n"
			+ "          number\n" + "          state\n" + "          createdAt\n" + "          updatedAt\n"
			+ "          title\n" + "          author {\n" + "            login\n" + "          }" + "        }\n"
			+ "      }\n" + "    }\n";
	...
	public static final String QUERY_NEW_ISSUE_CHECK = "query ($owner: String!, $name: String!) {\n"
			+ "  repository(owner: $owner, name: $name) {\n"
