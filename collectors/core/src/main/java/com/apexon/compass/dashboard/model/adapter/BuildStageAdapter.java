package com.apexon.compass.dashboard.model.adapter;

import com.apexon.compass.dashboard.model.BuildStage;
import com.apexon.compass.dashboard.model.Error;
...
public class BuildStageAdapter implements JsonDeserializer<BuildStage> {
	...
	@Override
	public BuildStage deserialize(JsonElement jsonElement, Type type,
