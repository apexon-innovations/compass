...
public class CustomFeatureTestReport implements QualityVisitee {
	...
	public static class Feature {
		...
		public String getAccessbilityTestResultStatus() {
			return accessbilityTestResultStatus;
		}
		...
		public Integer getTestCasesFailedCount() {
			return testCasesFailedCount;
		}

		public Integer getTestCasesPassedCount() {
			return testCasesPassedCount;
		}

		public Integer getTestCasesSkippedCount() {
			return testCasesSkippedCount;
		}

		public List<CustomFeatureTestCase> getTestCases() {
			return testCases;
		}
