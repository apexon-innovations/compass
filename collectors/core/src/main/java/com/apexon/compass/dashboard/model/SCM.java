...
/**
 * Base class to represent the details of a change in a source code management system.
 */
public class SCM {
	...
	public SCM(String scmUrl, String scmBranch, String scmRevisionNumber, String scmCommitLog, String scmAuthor,
			String scmAuthorType, String scmAuthorLogin, List<String> scmParentRevisionNumbers, List<RepoFile> files,
			long scmCommitTimestamp, long numberOfChanges, CommitType type) {
	...
	public String getScmAuthorType() {
		return scmAuthorType;
	}

	public void setScmAuthorType(String scmAuthorType) {
		this.scmAuthorType = scmAuthorType;
	}
	...
	public void setScmCommitter(String scmCommitter) {
		this.scmCommitter = scmCommitter;
	}

	public String getScmCommitterLogin() {
		return scmCommitterLogin;
	}

	public void setScmCommitterLogin(String scmCommitterLogin) {
		this.scmCommitterLogin = scmCommitterLogin;
	}
	...
	public String getScmAuthorName() {
		return scmAuthorName;
	}

	public void setScmAuthorName(String scmAuthorName) {
		this.scmAuthorName = scmAuthorName;
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof SCM))
			return false;
		SCM scm = (SCM) o;
		return getScmCommitTimestamp() == scm.getScmCommitTimestamp() && Objects.equals(getScmUrl(), scm.getScmUrl())
	...
	@Override
	public int hashCode() {
		return Objects.hash(getScmUrl(), getScmBranch(), getScmRevisionNumber(), getScmCommitLog(), getScmAuthor(),
				getScmAuthorLogin(), getScmCommitTimestamp());
	}
