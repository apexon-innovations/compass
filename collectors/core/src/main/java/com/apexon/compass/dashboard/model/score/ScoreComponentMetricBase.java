...
public class ScoreComponentMetricBase {
	...
	public String toString() {
		return "ScoreComponentMetricBase{" + "score='" + score + '\'' + ", total='" + total + '\'' + ", weight='"
				+ weight + '\'' + ", refId='" + refId + '\'' + ", displayId='" + displayId + '\'' + ", displayName='"
				+ displayName + '\'' + ", message='" + message + '\'' + ", propagate='" + propagate + '\'' + ", state='"
				+ state + '\'' + ", noScore=" + noScore + '\'' + ", alert=" + alert + ", options=" + options + '}';
	}
