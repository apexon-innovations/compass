...
/**
 * Represents code quality at a specific point in time. This could include a unit test
 * run, a security scan, static analysis, functional tests, manual acceptance tests or bug
 * reports.
 *
 * Possible Collectors: Sonar (in scope) Fortify ALM Various build system test results
 *
 */
