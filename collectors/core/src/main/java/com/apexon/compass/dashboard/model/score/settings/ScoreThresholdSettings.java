...
public class ScoreThresholdSettings {
	...
	public enum ComparatorType {
		...
		equals, less, greater, less_or_equal, greater_or_equal
	...
	public static ScoreThresholdSettings cloneScoreThresholdSettings(ScoreThresholdSettings scoreThresholdSettings) {
		...
		scoreThresholdSettingsClone.setScore(ScoreTypeValue.cloneScoreTypeValue(scoreThresholdSettings.getScore()));
	...
	public String toString() {
		return "ScoreThresholdSettings{" + "comparator=" + comparator + ", type=" + type + ", score=" + score
				+ ", numDaysToCheck=" + numDaysToCheck + ", value=" + value + '}';
	}
