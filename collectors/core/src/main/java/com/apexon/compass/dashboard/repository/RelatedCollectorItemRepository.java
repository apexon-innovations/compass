 ...
 */
public interface RelatedCollectorItemRepository
		extends CrudRepository<RelatedCollectorItem, ObjectId>, QuerydslPredicateExecutor<RelatedCollectorItem> {
	...
	List<RelatedCollectorItem> findAllByReasonAndCreationTimeIsBetweenOrderByCreationTimeDesc(String reason,
