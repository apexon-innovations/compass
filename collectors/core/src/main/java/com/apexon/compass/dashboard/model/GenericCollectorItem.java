...
/**
 * A generic structure to hold a generic collector item info for a given tool that only
 * that tool collector can decipher. This will be used in creating collector item via API
 * for non-standard tools.
 */
...
public class GenericCollectorItem extends BaseModel {
	...
	private ObjectId buildId; // if started off by some build - connects to build
								// collection
