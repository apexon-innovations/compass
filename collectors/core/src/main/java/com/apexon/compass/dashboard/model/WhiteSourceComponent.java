...
public class WhiteSourceComponent extends CollectorItem {
	...
	public Boolean getLocalConfig() {
		return (Boolean) getOptions().get(LOCAL_CONFIG);
	}

	public void setLocalConfig(Boolean b) {
		getOptions().put(LOCAL_CONFIG, b);
	}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (o == null || !(o instanceof WhiteSourceComponent))
			return false;

		WhiteSourceComponent that = (WhiteSourceComponent) o;
		return Objects.equals(getOrgName(), that.getOrgName())
				&& Objects.equals(getProjectToken(), that.getProjectToken());
	}
