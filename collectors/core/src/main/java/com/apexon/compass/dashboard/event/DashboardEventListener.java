...
/**
 * Listens for Dashboard lifecycle events to create and delete Product collector
 * CollectorItems whenever a Team Dashboard is created or deleted.
 */
@Component
public class DashboardEventListener extends AbstractMongoEventListener<Dashboard> {
	...
	private CollectorItem getDashboardCollectorItem(String dashboardId, ObjectId id) {
		return collectorItemRepository.findTeamDashboardCollectorItemsByCollectorIdAndDashboardId(id, dashboardId);
	}
