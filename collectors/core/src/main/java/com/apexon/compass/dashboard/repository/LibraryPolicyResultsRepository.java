...
import com.apexon.compass.dashboard.model.LibraryPolicyResult;
 ...
 */
public interface LibraryPolicyResultsRepository
		extends CrudRepository<LibraryPolicyResult, ObjectId>, QuerydslPredicateExecutor<LibraryPolicyResult> {
	...
	List<LibraryPolicyResult> findByCollectorItemIdAndTimestampIsBetweenOrderByTimestampDesc(ObjectId collectorItemId,
			long beginDate, long endDate);

	List<LibraryPolicyResult> findByCollectorItemIdAndEvaluationTimestampIsBetweenOrderByTimestampDesc(
