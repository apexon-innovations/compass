package com.apexon.compass.dashboard.model.score.settings;
...
public class QualityScoreSettings extends ScoreComponentSettings {
	...
	public static QualityScoreSettings cloneQualityScoreSettings(QualityScoreSettings qualityScoreSettings) {
		...
		qualityScoreSettingsClone
			.setUnitTests(ScoreComponentSettings.cloneScoreComponentSettings(qualityScoreSettings.getUnitTests()));
		qualityScoreSettingsClone
			.setViolations(ViolationsScoreSettings.cloneViolationsScoreSettings(qualityScoreSettings.getViolations()));
	...
	public static class ViolationsScoreSettings extends ScoreComponentSettings {
		...
		public static ViolationsScoreSettings cloneViolationsScoreSettings(
				ViolationsScoreSettings violationsScoreSettings) {
			...
			violationsScoreSettingsClone.setAllowNegative(violationsScoreSettings.isAllowNegative());
			violationsScoreSettingsClone
				.setBlockerViolationsWeight(violationsScoreSettings.getBlockerViolationsWeight());
			violationsScoreSettingsClone
				.setCriticalViolationsWeight(violationsScoreSettings.getCriticalViolationsWeight());
			violationsScoreSettingsClone.setMajorViolationWeight(violationsScoreSettings.getMajorViolationWeight());
		...
		public String toString() {
			return "ViolationsScoreSettings{" + "blockerViolationsWeight=" + blockerViolationsWeight
					+ ", criticalViolationsWeight=" + criticalViolationsWeight + ", majorViolationWeight="
					+ majorViolationWeight + ", allowNegative=" + allowNegative + ", disabled=" + isDisabled()
					+ ", weight=" + getWeight() + ", criteria=" + getCriteria() + '}';
		}
	...
	@Override
	public String toString() {
		return "QualityScoreSettings{" + "codeCoverage=" + codeCoverage + ", unitTests=" + unitTests + ", violations="
				+ violations + ", disabled=" + isDisabled() + ", weight=" + getWeight() + ", criteria=" + getCriteria()
				+ '}';
	}
