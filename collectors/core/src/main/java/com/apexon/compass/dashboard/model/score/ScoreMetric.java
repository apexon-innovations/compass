...
import com.apexon.compass.dashboard.model.BaseModel;
...
public class ScoreMetric extends BaseModel {
	...
	public String toString() {
		return "ScoreMetric{" + "collectorItemId=" + collectorItemId + ", scoreTypeId=" + scoreTypeId + ", timestamp="
				+ timestamp + ", score='" + score + '\'' + ", total='" + total + '\'' + ", failureMssg='" + failureMssg
				+ '\'' + ", noScore=" + noScore + ", componentMetrics=" + componentMetrics + ", options=" + options
				+ '\'' + '}';
	}
