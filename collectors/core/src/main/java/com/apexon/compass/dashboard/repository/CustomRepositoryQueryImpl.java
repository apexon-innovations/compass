...
import com.apexon.compass.dashboard.util.GitHubParsedUrl;
...
public class CustomRepositoryQueryImpl implements CustomRepositoryQuery {
	...
	@Override
	public List<CollectorItem> findCollectorItemsBySubsetOptions(ObjectId id, Map<String, Object> allOptions,
	...
	@Override
	public List<com.apexon.compass.dashboard.model.Component> findComponents(Collector collector) {
		Criteria c = Criteria.where("collectorItems." + collector.getCollectorType() + ".collectorId")
			.is(collector.getId());
		return template.find(new Query(c), com.apexon.compass.dashboard.model.Component.class);
	}

	@Override
	public List<com.apexon.compass.dashboard.model.Component> findComponents(CollectorType collectorType) {
	...
	@Override
	public List<com.apexon.compass.dashboard.model.Component> findComponents(ObjectId collectorId,
			CollectorType collectorType, CollectorItem collectorItem) {
		return findComponents(collectorId, collectorType, collectorItem.getId());
	}

	@Override
	public List<com.apexon.compass.dashboard.model.Component> findComponents(ObjectId collectorId,
			CollectorType collectorType, ObjectId collectorItemId) {
