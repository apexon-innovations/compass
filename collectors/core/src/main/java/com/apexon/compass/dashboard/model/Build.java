...
/**
 * The result of a Continuous Integration build execution. Typically produces binary
 * artifacts. Often triggered by one or more SCM commits.
 *
...
public class Build extends BaseModel {
	...
	public Map<String, String> getDeployMetadata() {
		return deployMetadata;
	}

	public void setDeployMetadata(Map<String, String> deployMetadata) {
