...
/**
 * A collection of widgets, collectors and application components that represent a
 * software project under development and/or in production use.
 *
 */
...
public class Dashboard extends BaseModel {
	...
	public Dashboard(String template, String title, Application application, List<Owner> owners, DashboardType type,
			String configurationItemBusServName, String configurationItemBusAppName, List<String> activeWidgets,
			boolean scoreEnabled, ScoreDisplayType scoreDisplay) {
		this(false, template, title, application, owners, type, configurationItemBusServName,
				configurationItemBusAppName, activeWidgets, scoreEnabled, scoreDisplay, new HashMap<>());
	}

	public Dashboard(boolean remoteCreated, String template, String title, Application application, List<Owner> owners,
			DashboardType type, String configurationItemBusServName, String configurationItemBusAppName,
			List<String> activeWidgets, boolean scoreEnabled, ScoreDisplayType scoreDisplay) {
