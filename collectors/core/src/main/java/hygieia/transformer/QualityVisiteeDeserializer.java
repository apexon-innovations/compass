...
public class QualityVisiteeDeserializer extends JsonDeserializer<QualityVisitee> {
	...
	@Override
	public QualityVisitee deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
			throws IOException {
		// this is a simple test, but we've only got 2 to distinguish between here, so
		// this test will suffice
