...
class DashboardTest {
	...
	@Test
	void findEnvironmentMappings() throws HygieiaException {
		Dashboard dashboard = makeTeamDashboard("template", "title", "appName", "", "ASVTEST", "BAPTEST", "comp1",
				"comp2");
	...
	@Test
	void findEnvironmentMappings_no_mappings_configured() throws HygieiaException {
		Dashboard dashboard = makeTeamDashboard("template", "title", "appName", "", "ASVTEST", "BAPTEST", "comp1",
				"comp2");
		Map<PipelineStage, String> expected = new HashMap<>();
	...
	private Dashboard makeTeamDashboard(String template, String title, String appName, String owner,
			String configItemAppName, String configItemComponentName, String... compNames) {
		...
		Dashboard dashboard = new Dashboard(template, title, app, owners, DashboardType.Team, configItemAppName,
				configItemComponentName, activeWidgets, false, ScoreDisplayType.HEADER);
		return dashboard;
	}
