...
/**
 * Collector implementation for Feature that stores system configuration settings required
 * for source system data connection (e.g., API tokens, etc.)
 *
 * @author KFK884
 */
public class FeatureCollector extends Collector {
	...
	/**
	 * Creates a static prototype of the Feature Collector, which includes any specific
	 * settings or configuration required for the use of this collector, including
	 * settings for connecting to any source systems.
